...
int main(int argc, char** argv) {
    ...
    Display display("Lab 06 - OpenCV Camera");
    KeyProcessor keyProcessor;
    FrameProcessor frameProcessor;
    FrameSettings settings;
    settings.drawingLayer = cv::Mat::zeros(720, 1280, CV_8UC3);
    settings.crosshair = {settings.drawingLayer.cols / 2, settings.drawingLayer.rows / 2};
